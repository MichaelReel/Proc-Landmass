...
var vel = Vector3()
export (float) var mouse_sensitivity : float = 0.10
export (float) var max_speed : float = 100           # Fastest camera can reach
export (float) var acceleration : float = 3.5               # How fast we get to top speed
export (float) var deceleration : float = 16              # How fast we come to a complete stop
